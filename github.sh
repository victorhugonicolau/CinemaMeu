...
export repositorio="https://github.com/victorhugonicolau/CinemaMeu.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="CinemaMeu-$(date +%d%m%Y)"
...
git commit -am "Criando a página dos filmes ---> $(date)"
